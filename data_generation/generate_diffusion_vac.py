...
def process_images(folder_path, model_id, h_space, num_inference_steps, num_sampling_runs=64, walked_distance=10):
...
if __name__ == '__main__':
    ...
    process_images(input_folder, 'ldm', 'after', 80,
                   walked_distance=10, num_sampling_runs=64)
